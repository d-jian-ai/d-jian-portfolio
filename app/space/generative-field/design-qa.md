...
- The mountain sampler now spans a broad 25.6 by 20 world. A winding valley center runs along the full depth axis, with paired continuous walls, an eroded gorge floor, west/east summits, a far crown, tributary cuts, outer mountain mass, strata, and floor ripples. Three semantic line paths trace the river floor and both ridge spines so the valley remains legible during camera motion.
