  ...
  zh: {
    ...
    space: {
      ...
      experiments: {
        ...
        polySpecies: {
          title: "多面生命",
          summary: "三十枚低多边形面片在四种原创数字物种之间连续重组。",
          category: "低多边形交互",
          status: "可触摸形态",
        },
      },
  ...
  en: {
    ...
    space: {
      ...
      experiments: {
        ...
        polySpecies: {
          title: "Poly species",
          summary: "Thirty low-poly shards continuously reorganize across four original digital species.",
          category: "Low-poly interaction",
          status: "Tactile morphology",
        },
      },
    },
    generativeField: {
    ...
    space: {
      ...
      experiments: {
        ...
        polySpecies: {
          ...
          summary: "Trente facettes low-poly se réorganisent entre quatre espèces numériques originales.",
          category: "Interaction low-poly",
          status: "Morphologie tactile",
        },
      },
    },
    generativeField: {
