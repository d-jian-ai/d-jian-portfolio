...
const STATISTIC_TITLES: Record<string, { zh: string; fr: string }> = {
  ...
  "IUCN Red List status": { zh: "IUCN 红色名录等级", fr: "Statut Liste rouge UICN" },
  "Known localities": { zh: "已知分布点", fr: "Localités connues" },
  ...
  "Surviving range": { zh: "现存分布范围", fr: "Aire de survie" },
...
const STATISTIC_NOTES: Record<string, { zh: string; fr: string }> = {
  ...
  "Current global assessment category": { zh: "当前全球评估等级", fr: "Catégorie d'évaluation mondiale actuelle" },
  "Known population localities": { zh: "有记录种群的已知地点数量", fr: "Localités connues abritant des populations" },
  ...
  "Wild populations survive on only a few western Fiji islands": { zh: "野生种群仅存于斐济西部少数岛屿", fr: "Les populations sauvages ne subsistent que sur quelques îles de l'ouest des Fidji" },
...
const STATISTIC_STATUS_VALUES: Record<string, { zh: string; en: string; fr: string }> = {
  ...
  "Few islands": { zh: "少数岛屿", en: "Few islands", fr: "Quelques îles" },
  Fewer: { zh: "较少", en: "Fewer", fr: "Moins" },
  "Rapid decline": { zh: "快速下降", en: "Rapid decline", fr: "Déclin rapide" },
